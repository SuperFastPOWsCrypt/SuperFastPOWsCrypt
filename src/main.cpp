...
#if defined(NDEBUG)
# error "SuperFastPOWsCrypt cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xb8c94ccde16221a3ec0d2e011590be391213ccb916494188cb7f39bfb1511e08");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // SuperFastPOWsCrypt: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "SuperFastPOWsCrypt Signed Message:\n";
...
{
    // SuperFastPOWsCrypt: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // SuperFastPOWsCrypt: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // SuperFastPOWsCrypt: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb8c94ccde16221a3ec0d2e011590be391213ccb916494188cb7f39bfb1511e08");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "2015-10-11-SuperFastPOWsCrypt";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("052274710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1444583508;
        ...
        assert(block.hashMerkleRoot == uint256("0xbaf271a102be6a8dedb63e62d03a25c15b1f9a642e1dbfffb5a8a16637d4ba54"));
...
unsigned char pchMessageStart[4] = { 0xd3, 0xc2, 0xc1, 0xcd };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("SuperFastPOWsCryptMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SuperFastPOWsCryptMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SuperFastPOWsCryptMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static SuperFastPOWsCryptMiner(CWallet *pwallet)
{
    printf("SuperFastPOWsCryptMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("superfastpowscrypt-miner");
    ...
    try { loop {
        ...
        printf("Running SuperFastPOWsCryptMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("SuperFastPOWsCryptMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&SuperFastPOWsCryptMiner, pwallet));
}
